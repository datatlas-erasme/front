...
import CustomMapPopover from './index';
import { PopHover } from './style';
import CustomMapModal from '../modal/Modal';
import { WrapperModal } from '../modal/style';
...
export default MapPopoverWrapper;
