...
export const BullePicto = ({
  ...
  >
    <path d="M0.0174131 30.0976H29.9826V0.132388H0.0174131V30.0976Z" fill="url(#pattern0)" />
    <defs>
      <pattern id="pattern0" patternContentUnits="objectBoundingBox" width="1" height="1">
        <use xlinkHref="#image0_1117_132818" transform="scale(0.015625)" />
      </pattern>
      <image
        id="image0_1117_132818"
        width="64"
        height="64"
